...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Compta web application."
  #
  #
  ...
  #
  # settings.secret_key_base= umNGX3qk5DJiNwqRKo91UxsM8fnJrhnjaihIGN7loGs
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("compta.log", "w"))
  #
  #
end
